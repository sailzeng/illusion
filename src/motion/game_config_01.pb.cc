...
const ::google::protobuf::Descriptor* LIST_OF_GAME_CFG_STRUCT_1_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  LIST_OF_GAME_CFG_STRUCT_1_reflection_ = NULL;
...
void protobuf_AssignDesc_game_5fconfig_5f01_2eproto() {
  ...
  LIST_OF_GAME_CFG_STRUCT_1_descriptor_ = file->message_type(1);
  static const int LIST_OF_GAME_CFG_STRUCT_1_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LIST_OF_GAME_CFG_STRUCT_1, list_data_),
  };
  LIST_OF_GAME_CFG_STRUCT_1_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      LIST_OF_GAME_CFG_STRUCT_1_descriptor_,
      LIST_OF_GAME_CFG_STRUCT_1::default_instance_,
      LIST_OF_GAME_CFG_STRUCT_1_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LIST_OF_GAME_CFG_STRUCT_1, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LIST_OF_GAME_CFG_STRUCT_1, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(LIST_OF_GAME_CFG_STRUCT_1));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    LIST_OF_GAME_CFG_STRUCT_1_descriptor_, &LIST_OF_GAME_CFG_STRUCT_1::default_instance());
}
...
void protobuf_ShutdownFile_game_5fconfig_5f01_2eproto() {
  ...
  delete LIST_OF_GAME_CFG_STRUCT_1::default_instance_;
  delete LIST_OF_GAME_CFG_STRUCT_1_reflection_;
}
...
void protobuf_AddDesc_game_5fconfig_5f01_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024game_config_01.proto\032\016illusion.proto\"\206"
    "\003\n\021GAME_CFG_STRUCT_1\022\033\n\004s1_a\030\001 \001(\005B\r\310\363\030\001"
    "\322\363\030\005CFG_1\022\033\n\004s1_b\030\002 \001(\rB\r\310\363\030\001\322\363\030\005CFG_2\022\033"
    "\n\004s1_c\030\003 \001(\003B\r\310\363\030\001\322\363\030\005CFG_3\022\033\n\004s1_d\030\004 \001("
    "\004B\r\310\363\030\001\322\363\030\005CFG_4\022\033\n\004s1_e\030\005 \001(\001B\r\310\363\030\001\322\363\030\005"
    "CFG_5\022\033\n\004s1_f\030\006 \001(\002B\r\310\363\030\001\322\363\030\005CFG_6\022\033\n\004s1"
    "_g\030\007 \001(\010B\r\310\363\030\001\322\363\030\005CFG_7\022\033\n\004s1_h\030\010 \001(\tB\r\310"
    "\363\030\001\322\363\030\005CFG_8\022\033\n\004s1_i\030\t \001(\014B\r\310\363\030\001\322\363\030\005CFG_"
    "9\022 \n\004s1_j\030\n \003(\005B\022\310\363\030\001\322\363\030\006CFG_10\330\363\030\004\022 \n\004s"
    "1_k\030\013 \003(\tB\022\310\363\030\001\322\363\030\006CFG_11\330\363\030\004\022(\n\004s1_l\030\014 "
    "\001(\0162\n.ENUM_WEEKB\016\310\363\030\001\322\363\030\006CFG_12\"\231\001\n\031LIST"
    "_OF_GAME_CFG_STRUCT_1\022%\n\tlist_data\030\001 \003(\013"
    "2\022.GAME_CFG_STRUCT_1:U\210\265\030\001\222\265\030\023game_confi"
    "g_01.xlsx\232\265\030\021GAME_CFG_STRUCT_1\272\265\030\025GAME_C"
    "FG_STRUCT_1.bin\240\265\030\001\250\265\030\002\260\265\030\003*\263\001\n\tENUM_WEE"
    "K\022\026\n\003MON\020\001\032\r\242\265\030\t\346\230\237\346\234\237\344\270\200\022\026\n\003TUE\020\002\032\r\242\265\030\t"
    "\346\230\237\346\234\237\344\272\214\022\026\n\003WED\020\003\032\r\242\265\030\t\346\230\237\346\234\237\344\270\211\022\026\n\003THU"
    "\020\004\032\r\242\265\030\t\346\230\237\346\234\237\345\233\233\022\026\n\003FRI\020\005\032\r\242\265\030\t\346\230\237\346\234\237\344\272"
    "\224\022\026\n\003SAT\020\006\032\r\242\265\030\t\346\230\237\346\234\237\345\205\255\022\026\n\003SUN\020\007\032\r\242\265\030\t"
    "\346\230\237\346\234\237\346\227\245", 769);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "game_config_01.proto", &protobuf_RegisterTypes);
  GAME_CFG_STRUCT_1::default_instance_ = new GAME_CFG_STRUCT_1();
  LIST_OF_GAME_CFG_STRUCT_1::default_instance_ = new LIST_OF_GAME_CFG_STRUCT_1();
  GAME_CFG_STRUCT_1::default_instance_->InitAsDefaultInstance();
  LIST_OF_GAME_CFG_STRUCT_1::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int LIST_OF_GAME_CFG_STRUCT_1::kListDataFieldNumber;
#endif  // !_MSC_VER

LIST_OF_GAME_CFG_STRUCT_1::LIST_OF_GAME_CFG_STRUCT_1()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:LIST_OF_GAME_CFG_STRUCT_1)
}

void LIST_OF_GAME_CFG_STRUCT_1::InitAsDefaultInstance() {
}

LIST_OF_GAME_CFG_STRUCT_1::LIST_OF_GAME_CFG_STRUCT_1(const LIST_OF_GAME_CFG_STRUCT_1& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:LIST_OF_GAME_CFG_STRUCT_1)
}

void LIST_OF_GAME_CFG_STRUCT_1::SharedCtor() {
  _cached_size_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}

LIST_OF_GAME_CFG_STRUCT_1::~LIST_OF_GAME_CFG_STRUCT_1() {
  // @@protoc_insertion_point(destructor:LIST_OF_GAME_CFG_STRUCT_1)
  SharedDtor();
}

void LIST_OF_GAME_CFG_STRUCT_1::SharedDtor() {
  if (this != default_instance_) {
  }
}

void LIST_OF_GAME_CFG_STRUCT_1::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* LIST_OF_GAME_CFG_STRUCT_1::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return LIST_OF_GAME_CFG_STRUCT_1_descriptor_;
}

const LIST_OF_GAME_CFG_STRUCT_1& LIST_OF_GAME_CFG_STRUCT_1::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_game_5fconfig_5f01_2eproto();
  return *default_instance_;
}

LIST_OF_GAME_CFG_STRUCT_1* LIST_OF_GAME_CFG_STRUCT_1::default_instance_ = NULL;

LIST_OF_GAME_CFG_STRUCT_1* LIST_OF_GAME_CFG_STRUCT_1::New() const {
  return new LIST_OF_GAME_CFG_STRUCT_1;
}

void LIST_OF_GAME_CFG_STRUCT_1::Clear() {
  list_data_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  mutable_unknown_fields()->Clear();
}

bool LIST_OF_GAME_CFG_STRUCT_1::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:LIST_OF_GAME_CFG_STRUCT_1)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:LIST_OF_GAME_CFG_STRUCT_1)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:LIST_OF_GAME_CFG_STRUCT_1)
  return false;
#undef DO_
}

void LIST_OF_GAME_CFG_STRUCT_1::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:LIST_OF_GAME_CFG_STRUCT_1)
  // repeated .GAME_CFG_STRUCT_1 list_data = 1;
  ...
  // @@protoc_insertion_point(serialize_end:LIST_OF_GAME_CFG_STRUCT_1)
}

::google::protobuf::uint8* LIST_OF_GAME_CFG_STRUCT_1::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:LIST_OF_GAME_CFG_STRUCT_1)
  // repeated .GAME_CFG_STRUCT_1 list_data = 1;
  for (int i = 0; i < this->list_data_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
  ...
  // @@protoc_insertion_point(serialize_to_array_end:LIST_OF_GAME_CFG_STRUCT_1)
  return target;
}

int LIST_OF_GAME_CFG_STRUCT_1::ByteSize() const {
  int total_size = 0;
...
void LIST_OF_GAME_CFG_STRUCT_1::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const LIST_OF_GAME_CFG_STRUCT_1* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const LIST_OF_GAME_CFG_STRUCT_1*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void LIST_OF_GAME_CFG_STRUCT_1::MergeFrom(const LIST_OF_GAME_CFG_STRUCT_1& from) {
  GOOGLE_CHECK_NE(&from, this);
  list_data_.MergeFrom(from.list_data_);
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}

void LIST_OF_GAME_CFG_STRUCT_1::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void LIST_OF_GAME_CFG_STRUCT_1::CopyFrom(const LIST_OF_GAME_CFG_STRUCT_1& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool LIST_OF_GAME_CFG_STRUCT_1::IsInitialized() const {

  return true;
}

void LIST_OF_GAME_CFG_STRUCT_1::Swap(LIST_OF_GAME_CFG_STRUCT_1* other) {
  if (other != this) {
...
::google::protobuf::Metadata LIST_OF_GAME_CFG_STRUCT_1::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = LIST_OF_GAME_CFG_STRUCT_1_descriptor_;
  metadata.reflection = LIST_OF_GAME_CFG_STRUCT_1_reflection_;
  return metadata;
}
