...
class LIST_OF_GAME_CFG_STRUCT_1;
...
class LIST_OF_GAME_CFG_STRUCT_1 : public ::google::protobuf::Message {
 public:
  LIST_OF_GAME_CFG_STRUCT_1();
  virtual ~LIST_OF_GAME_CFG_STRUCT_1();

  LIST_OF_GAME_CFG_STRUCT_1(const LIST_OF_GAME_CFG_STRUCT_1& from);

  inline LIST_OF_GAME_CFG_STRUCT_1& operator=(const LIST_OF_GAME_CFG_STRUCT_1& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const LIST_OF_GAME_CFG_STRUCT_1& default_instance();

  void Swap(LIST_OF_GAME_CFG_STRUCT_1* other);

  // implements Message ----------------------------------------------

  LIST_OF_GAME_CFG_STRUCT_1* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const LIST_OF_GAME_CFG_STRUCT_1& from);
  void MergeFrom(const LIST_OF_GAME_CFG_STRUCT_1& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline const ::GAME_CFG_STRUCT_1& list_data(int index) const;
  inline ::GAME_CFG_STRUCT_1* mutable_list_data(int index);
  inline ::GAME_CFG_STRUCT_1* add_list_data();
  inline const ::google::protobuf::RepeatedPtrField< ::GAME_CFG_STRUCT_1 >&
      list_data() const;
  inline ::google::protobuf::RepeatedPtrField< ::GAME_CFG_STRUCT_1 >*
      mutable_list_data();

  // @@protoc_insertion_point(class_scope:LIST_OF_GAME_CFG_STRUCT_1)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::GAME_CFG_STRUCT_1 > list_data_;
  friend void  protobuf_AddDesc_game_5fconfig_5f01_2eproto();
  friend void protobuf_AssignDesc_game_5fconfig_5f01_2eproto();
  friend void protobuf_ShutdownFile_game_5fconfig_5f01_2eproto();

  void InitAsDefaultInstance();
  static LIST_OF_GAME_CFG_STRUCT_1* default_instance_;
};
// ===================================================================
...
// repeated .GAME_CFG_STRUCT_1 list_data = 1;
inline int LIST_OF_GAME_CFG_STRUCT_1::list_data_size() const {
  return list_data_.size();
}
inline void LIST_OF_GAME_CFG_STRUCT_1::clear_list_data() {
  list_data_.Clear();
}
inline const ::GAME_CFG_STRUCT_1& LIST_OF_GAME_CFG_STRUCT_1::list_data(int index) const {
  // @@protoc_insertion_point(field_get:LIST_OF_GAME_CFG_STRUCT_1.list_data)
  return list_data_.Get(index);
}
inline ::GAME_CFG_STRUCT_1* LIST_OF_GAME_CFG_STRUCT_1::mutable_list_data(int index) {
  // @@protoc_insertion_point(field_mutable:LIST_OF_GAME_CFG_STRUCT_1.list_data)
  return list_data_.Mutable(index);
}
inline ::GAME_CFG_STRUCT_1* LIST_OF_GAME_CFG_STRUCT_1::add_list_data() {
  // @@protoc_insertion_point(field_add:LIST_OF_GAME_CFG_STRUCT_1.list_data)
  return list_data_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::GAME_CFG_STRUCT_1 >&
LIST_OF_GAME_CFG_STRUCT_1::list_data() const {
  // @@protoc_insertion_point(field_list:LIST_OF_GAME_CFG_STRUCT_1.list_data)
  return list_data_;
}
inline ::google::protobuf::RepeatedPtrField< ::GAME_CFG_STRUCT_1 >*
LIST_OF_GAME_CFG_STRUCT_1::mutable_list_data() {
  // @@protoc_insertion_point(field_mutable_list:LIST_OF_GAME_CFG_STRUCT_1.list_data)
  return &list_data_;
}
